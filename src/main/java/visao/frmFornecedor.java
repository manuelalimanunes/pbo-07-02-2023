...
public class frmFornecedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbFornecedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nome", "CNPJ", "E-mail", "Telefone", "Celular", "CEP", "Endereço", "Numero", "Complemento", "Bairro", "Cidade", "Estado"
            }
        ));
        tbFornecedores.setToolTipText("");
        tbFornecedores.setName("tbFornecedores"); // NOI18N
    ...
    private void tbFornecedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbFornecedoresMouseClicked
       jTabbedPane1.setSelectedIndex(0);
        ...
        txtCnpj.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 3).toString());
        txtEmail.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 4).toString());
        txtTelefone.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 5).toString());
        txtCelular.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 6).toString());
        txtCep.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 7).toString());
        txtEndereco.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 8).toString());
        txtNumero.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 9).toString());
        txtComplemento.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 10).toString());
        txtBairro.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 11).toString());
        txtCidade.setText(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 12).toString());
        txtEstado.setSelectedItem(tbFornecedores.getValueAt(tbFornecedores.getSelectedRow(), 13).toString());
    ...
    private void btnPesquisaClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisaClienteMouseClicked
        ...
        Fornecedores obj = new Fornecedores();
        FornecedoresDAO dao = new FornecedoresDAO();
        obj = dao.consultaFornecedoresPorNome(nome);
        if(obj.getNome()!=null){
